...
export const AI_HANDS_AGENTS: SystemFeature[] = [
  ...
  },
  {
    ...
    technicalDetail: 'DALL-E 3 primario → Gemini 2.5 Flash fallback → Placeholder garantizado. Sanitización de políticas de contenido (28 términos legales sensibles → reemplazos abstractos), inyección de color de marca (#1E1C92), overlay de logo con Sharp (150px sobre fondo blanco, esquina inferior derecha).',
