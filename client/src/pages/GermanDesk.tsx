...
export default function GermanDesk() {
  ...
  const content = {
    en: {
      ...
      experienceText1: "For more than 34 years, Santos & Saucedo has been the trusted legal advisor for German and Austrian companies establishing and expanding their operations in Mexico. Our German Desk provides specialized legal services tailored to the unique needs of German-speaking clients.",
    ...
    es: {
      ...
      experienceText1: "Durante más de 34 años, Santos & Saucedo ha sido el asesor legal de confianza para empresas alemanas y austriacas que establecen y expanden sus operaciones en México. Nuestro German Desk proporciona servicios legales especializados adaptados a las necesidades únicas de clientes de habla alemana.",
    ...
    de: {
      ...
      experienceText1: "Seit mehr als 34 Jahren ist Santos & Saucedo der vertrauenswürdige Rechtsberater für deutsche und österreichische Unternehmen, die ihre Geschäftstätigkeit in Mexiko aufbauen und erweitern. Unser German Desk bietet spezialisierte Rechtsdienstleistungen, die auf die besonderen Bedürfnisse deutschsprachiger Mandanten zugeschnitten sind.",
    ...
    zh: {
      ...
      experienceText1: "34年来，Santos & Saucedo一直是德国和奥地利企业在墨西哥设立和扩展业务的可信赖法律顾问。我们的德国业务部提供专业的法律服务，针对德语客户的独特需求量身定制。",
    ...
    ko: {
      ...
      experienceText1: "34년 이상 Santos & Saucedo는 멕시코에서 사업을 설립하고 확장하는 독일 및 오스트리아 기업들의 신뢰받는 법률 자문사였습니다. 저희 독일 데스크는 독일어권 고객의 고유한 요구에 맞춘 전문 법률 서비스를 제공합니다.",
    ...
    ja: {
      ...
      experienceText1: "34年以上にわたり、Santos & Saucedoはメキシコで事業を設立・拡大するドイツ・オーストリア企業の信頼できる法律顧問として活動してきました。当社のジャーマンデスクは、ドイツ語圏のクライアントの独自のニーズに合わせた専門的な法律サービスを提供しています。",
    ...
    ar: {
      ...
      experienceText1: "لأكثر من 34 عاماً، كان Santos & Saucedo المستشار القانوني الموثوق للشركات الألمانية والنمساوية التي تؤسس وتوسع عملياتها في المكسيك. يقدم مكتبنا الألماني خدمات قانونية متخصصة مصممة خصيصاً للاحتياجات الفريدة للعملاء الناطقين بالألمانية.",
    ...
    fr: {
      ...
      experienceText1: "Depuis plus de 34 ans, Santos & Saucedo est le conseiller juridique de confiance des entreprises allemandes et autrichiennes qui établissent et développent leurs opérations au Mexique. Notre German Desk fournit des services juridiques spécialisés adaptés aux besoins uniques des clients germanophones.",
    ...
    it: {
      ...
      experienceText1: "Da oltre 34 anni, Santos & Saucedo è il consulente legale di fiducia per le aziende tedesche e austriache che stabiliscono ed espandono le loro operazioni in Messico. Il nostro German Desk fornisce servizi legali specializzati su misura per le esigenze uniche dei clienti di lingua tedesca.",
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden" data-testid="page-german-desk">
      ...
      <section className="pt-36 pb-20 editorial-page-hero" data-testid="section-german-desk-hero">
