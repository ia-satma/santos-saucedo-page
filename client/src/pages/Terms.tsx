      ...
      sections: [
        {
          ...
          content: `By accessing and using the website of Santos & Saucedo Abogados (hereinafter "VWS," "the Firm," "we," "us," or "our"), located at www.santossaucedo.com (hereinafter "the Website"), you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions of Use (hereinafter "Terms").
...
Trademarks:
The VWS name, logo, and all related names, logos, product and service names, designs, and slogans are trademarks of Santos & Saucedo Abogados or its affiliates. You may not use such marks without the prior written permission of VWS. All other names, logos, product and service names, designs, and slogans on this Website are the trademarks of their respective owners.
      ...
      sections: [
        {
          ...
          content: `Al acceder y utilizar el sitio web de Santos & Saucedo Abogados (en adelante "VWS," "la Firma," "nosotros" o "nuestro"), ubicado en www.santossaucedo.com (en adelante "el Sitio Web"), usted reconoce que ha leído, comprendido y acepta estar obligado por estos Términos y Condiciones de Uso (en adelante "Términos").
...
Marcas Registradas:
El nombre VWS, el logotipo y todos los nombres, logotipos, nombres de productos y servicios, diseños y eslóganes relacionados son marcas registradas de Santos & Saucedo Abogados o sus afiliados. No puede usar dichas marcas sin el permiso previo por escrito de VWS.
...
Marken:
Der Name VWS, das Logo und alle verwandten Namen, Logos, Produkt- und Servicenamen, Designs und Slogans sind Marken von Santos & Saucedo Abogados oder ihren verbundenen Unternehmen. Sie dürfen diese Marken nicht ohne vorherige schriftliche Genehmigung von VWS verwenden.
      ...
      sections: [
        {
          ...
          icon: FileText,
          title: "1. 接受条款",
          content: `通过访问和使用Santos & Saucedo Abogados（以下简称"VWS"、"本所"、"我们"或"我们的"）的网站www.santossaucedo.com（以下简称"本网站"），您确认已阅读、理解并同意受这些使用条款（以下简称"条款"）的约束。
...
商标：
VWS名称、徽标及所有相关名称、徽标、产品和服务名称、设计和标语均为Santos & Saucedo Abogados或其关联公司的商标。未经VWS事先书面许可，您不得使用此类商标。
      ...
      sections: [
        {
          ...
          icon: FileText,
          title: "1. 약관 동의",
          content: `Santos & Saucedo Abogados(이하 "VWS", "본 법인", "당사" 또는 "당사의")의 웹사이트 www.santossaucedo.com(이하 "웹사이트")에 접속하고 사용함으로써, 귀하는 이 이용약관(이하 "약관")을 읽고 이해했으며 이에 구속되는 것에 동의합니다.
...
상표:
VWS 이름, 로고 및 모든 관련 이름, 로고, 제품 및 서비스 이름, 디자인 및 슬로건은 Santos & Saucedo Abogados 또는 그 계열사의 상표입니다. VWS의 사전 서면 허가 없이 이러한 상표를 사용할 수 없습니다.
      ...
      sections: [
        {
          ...
          icon: FileText,
          title: "1. 規約の承諾",
          content: `Santos & Saucedo Abogados（以下「VWS」、「当事務所」、「当社」または「当社の」）のウェブサイトwww.santossaucedo.com（以下「本ウェブサイト」）にアクセスし使用することにより、お客様はこの利用規約（以下「規約」）を読み、理解し、これに拘束されることに同意したことを認めます。
...
商標：
VWSの名称、ロゴ、およびすべての関連する名称、ロゴ、製品およびサービス名、デザイン、スローガンは、Santos & Saucedo Abogadosまたはその関連会社の商標です。VWSの事前の書面による許可なく、これらの商標を使用することはできません。
      ...
      sections: [
        {
          ...
          icon: FileText,
          title: "1. قبول الشروط",
          content: `من خلال الوصول إلى واستخدام موقع Santos & Saucedo Abogados (المشار إليها فيما بعد بـ "VWS" أو "الشركة" أو "نحن" أو "لنا") الموجود على www.santossaucedo.com (المشار إليه فيما بعد بـ "الموقع الإلكتروني")، فإنك تقر بأنك قد قرأت وفهمت ووافقت على الالتزام بشروط وأحكام الاستخدام هذه (المشار إليها فيما بعد بـ "الشروط").
...
العلامات التجارية:
اسم VWS والشعار وجميع الأسماء والشعارات وأسماء المنتجات والخدمات والتصاميم والشعارات ذات الصلة هي علامات تجارية مملوكة لـ Santos & Saucedo Abogados أو الشركات التابعة لها. لا يجوز لك استخدام هذه العلامات دون الحصول على إذن كتابي مسبق من VWS.
      ...
      sections: [
        {
          ...
          content: `Получая доступ и используя веб-сайт Santos & Saucedo Abogados (далее «VWS», «Фирма», «мы», «нас» или «наш»), расположенный по адресу www.santossaucedo.com (далее «Веб-сайт»), вы подтверждаете, что прочитали, поняли и согласны соблюдать настоящие Условия использования (далее «Условия»).
...
Товарные знаки:
Название VWS, логотип и все связанные названия, логотипы, названия продуктов и услуг, дизайны и слоганы являются товарными знаками Santos & Saucedo Abogados или её аффилированных лиц. Вы не можете использовать эти знаки без предварительного письменного разрешения VWS.
      ...
      sections: [
        {
          ...
          content: `En accédant et en utilisant le site web de Santos & Saucedo Abogados (ci-après « VWS », « le Cabinet », « nous », « notre » ou « nos »), situé à www.santossaucedo.com (ci-après « le Site Web »), vous reconnaissez avoir lu, compris et accepté d'être lié par les présentes Conditions d'utilisation (ci-après « Conditions »).
...
Marques :
Le nom VWS, le logo et tous les noms, logos, noms de produits et services, designs et slogans associés sont des marques de Santos & Saucedo Abogados ou de ses affiliés. Vous ne pouvez pas utiliser ces marques sans l'autorisation écrite préalable de VWS.
      ...
      sections: [
        {
          ...
          content: `Accedendo e utilizzando il sito web di Santos & Saucedo Abogados (di seguito "VWS", "lo Studio", "noi", "ci" o "nostro"), situato su www.santossaucedo.com (di seguito "il Sito Web"), riconosci di aver letto, compreso e di accettare di essere vincolato da questi Termini e Condizioni d'uso (di seguito "Termini").
...
Marchi:
Il nome VWS, il logo e tutti i nomi, loghi, nomi di prodotti e servizi, design e slogan correlati sono marchi di Santos & Saucedo Abogados o delle sue affiliate. Non puoi utilizzare tali marchi senza il previo consenso scritto di VWS.
