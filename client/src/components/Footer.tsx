...
export default function Footer() {
  ...
  const content: Record<string, {
    ...
    de: {
      ...
      email: siteContent?.email || "info@santossaucedo.com",
      legal: "© 2025 Santos & Saucedo Abogados Alle Rechte vorbehalten.",
    ...
    zh: {
      ...
      phone: siteContent?.phone || "+52 55 5258 1000",
      email: siteContent?.email || "info@santossaucedo.com",
      legal: "© 2025 Santos & Saucedo Abogados 版权所有。",
      privacy: "隐私声明",
      terms: "使用条款",
      cookies: "Cookie偏好设置",
    ...
    ko: {
      ...
      phone: siteContent?.phone || "+52 55 5258 1000",
      email: siteContent?.email || "info@santossaucedo.com",
      legal: "© 2025 Santos & Saucedo Abogados 모든 권리 보유.",
      privacy: "개인정보 처리방침",
      terms: "이용 약관",
      cookies: "쿠키 설정",
    ...
    ja: {
      ...
      phone: siteContent?.phone || "+52 55 5258 1000",
      email: siteContent?.email || "info@santossaucedo.com",
      legal: "© 2025 Santos & Saucedo Abogados 無断複写・転載を禁じます。",
      privacy: "プライバシーポリシー",
      terms: "利用規約",
      cookies: "Cookie設定",
    ...
    ar: {
      ...
      phone: siteContent?.phone || "+52 55 5258 1000",
      email: siteContent?.email || "info@santossaucedo.com",
      legal: "© 2025 Santos & Saucedo Abogados جميع الحقوق محفوظة.",
    ...
    ru: {
      ...
      phone: siteContent?.phone || "+52 55 5258 1000",
      email: siteContent?.email || "info@santossaucedo.com",
      legal: "© 2025 Santos & Saucedo Abogados Все права защищены.",
    ...
    fr: {
      ...
      phone: siteContent?.phone || "+52 55 5258 1000",
      email: siteContent?.email || "info@santossaucedo.com",
      legal: "© 2025 Santos & Saucedo Abogados Tous droits réservés.",
    ...
    it: {
      ...
      phone: siteContent?.phone || "+52 55 5258 1000",
      email: siteContent?.email || "info@santossaucedo.com",
      legal: "© 2025 Santos & Saucedo Abogados Tutti i diritti riservati.",
