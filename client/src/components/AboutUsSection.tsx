        ...
        >
          {featureCards.map(({ icon: Icon, title, text, testId }) => (
            <motion.div
              ...
              className="card-soft group relative overflow-hidden p-10 lg:p-12 flex flex-col gap-6"
              data-testid={testId}
            >
              {/* Icon circle */}
          ...
          {values.map((value, i) => {
            ...
            return (
              ...
              >
                ...
                <span
                  className="font-heading font-light uppercase tracking-[0.1em] text-lg md:text-xl text-foreground leading-none"
