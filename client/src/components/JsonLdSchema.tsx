...
const descriptions = {
  ...
  localBusiness: {
    ...
    de: "Hauptbüro von Santos & Saucedo im Torre SOMA Chapultepec, eine der renommiertesten Anwaltskanzleien Mexikos.",
    zh: "Santos & Saucedo主办公室，位于Torre SOMA Chapultepec，是墨西哥最负盛名的律师事务所之一。",
    ko: "Santos & Saucedo 본사 사무실, Torre SOMA Chapultepec에 위치, 멕시코에서 가장 명망 있는 로펌 중 하나입니다.",
    ja: "Santos & Saucedoの本社オフィス、Torre SOMA Chapultepecに位置し、メキシコで最も権威ある法律事務所の一つです。",
    ar: "المكتب الرئيسي لـ Santos & Saucedo، يقع في Torre SOMA Chapultepec، أحد أعرق شركات المحاماة في المكسيك.",
    ru: "Главный офис Santos & Saucedo, расположенный в Torre SOMA Chapultepec, одной из самых престижных юридических фирм Мексики.",
    fr: "Bureau principal de Santos & Saucedo, situé dans la Torre SOMA Chapultepec, l'un des cabinets d'avocats les plus prestigieux du Mexique.",
    it: "Sede principale di Santos & Saucedo, situata nella Torre SOMA Chapultepec, uno degli studi legali più prestigiosi del Messico.",
  },
  legalServices: {
    en: "Legal Services",
