...
const seoConfig: Record<string, SEOConfig> = {
  ...
  contact: {
    ...
    description: {
      en: "Get in touch with Santos & Saucedo. Visit our offices in Mexico City or contact our team for legal consultation and inquiries.",
      es: "Póngase en contacto con Santos & Saucedo. Visite nuestras oficinas en Ciudad de México o contacte a nuestro equipo para consultas legales.",
      de: "Nehmen Sie Kontakt mit Santos & Saucedo auf. Besuchen Sie unsere Büros in Mexiko-Stadt oder kontaktieren Sie unser Team für rechtliche Beratung.",
  ...
  offices: {
    ...
    description: {
      en: "Visit Santos & Saucedo at Torre SOMA Chapultepec in Polanco, Mexico City. Modern facilities with state-of-the-art amenities for clients and team members.",
      es: "Visite Santos & Saucedo en Torre SOMA Chapultepec en Polanco, Ciudad de México. Instalaciones modernas con amenidades de primera clase.",
      de: "Besuchen Sie Santos & Saucedo im Torre SOMA Chapultepec in Polanco, Mexiko-Stadt. Moderne Einrichtungen mit erstklassiger Ausstattung.",
      zh: "访问位于墨西哥城波朗科区Torre SOMA Chapultepec的Santos & Saucedo。配备一流设施的现代化办公环境。",
      ko: "멕시코시티 폴랑코의 Torre SOMA Chapultepec에 위치한 Santos & Saucedo를 방문하세요. 최신 시설을 갖춘 현대적인 사무실.",
      ja: "メキシコシティ・ポランコのTorre SOMA Chapultepecにあるオフィスをご訪問ください。最新設備を備えた近代的な施設。",
      ar: "قم بزيارة Santos & Saucedo في Torre SOMA Chapultepec في بولانكو، مكسيكو سيتي. مرافق حديثة مع وسائل راحة متطورة.",
      ru: "Посетите Santos & Saucedo в Torre SOMA Chapultepec в Поланко, Мехико. Современные помещения с первоклассным оснащением.",
      fr: "Visitez Santos & Saucedo à Torre SOMA Chapultepec à Polanco, Mexico. Installations modernes avec des équipements de pointe.",
      it: "Visita Santos & Saucedo presso Torre SOMA Chapultepec a Polanco, Città del Messico. Strutture moderne con servizi all'avanguardia.",
    },
    path: "/offices",
  },
  privacyPolicy: {
