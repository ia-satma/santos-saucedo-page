...
const seoConfig: Record<string, SEOConfig> = {
  ...
  offices: {
    ...
    description: {
      en: "Visit Santos & Saucedo at Río Tamazunchale 205 Norte in Nuevo León, Mexico City. Modern facilities with state-of-the-art amenities for clients and team members.",
      es: "Visite Santos & Saucedo en Río Tamazunchale 205 Norte en Nuevo León, Ciudad de México. Instalaciones modernas con amenidades de primera clase.",
      de: "Besuchen Sie Santos & Saucedo im Río Tamazunchale 205 Norte in Nuevo León, Mexiko-Stadt. Moderne Einrichtungen mit erstklassiger Ausstattung.",
