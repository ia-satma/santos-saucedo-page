...
const content: Record<LanguageCode, VisionContent> = {
  ...
  ar: {
    ...
    text: "أكملت Santos & Saucedo الانتقال إلى مكاتبها الجديدة في منطقة كامبوس إليسيوس الديناميكية في بولانكو. يمثل هذا النقل مرحلة من النمو والتطور والتوطيد، ويمثل استثماراً رئيسياً في مستقبل الشركة. تم تصميم المرافق الجديدة لتعظيم التعاون عبر جميع المجالات لصالح العملاء، مما يضمن استمرار تقديم خدمات عالية الجودة ومتكاملة.",
