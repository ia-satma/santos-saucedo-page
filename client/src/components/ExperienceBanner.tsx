...
export default function ExperienceBanner() {
  ...
  return (
    <section
      className="relative overflow-hidden py-16 lg:py-20 bg-[radial-gradient(circle_at_82%_20%,rgba(32,32,88,0.78)_0%,rgba(23,23,53,0.64)_34%,rgba(14,15,44,0.96)_74%),linear-gradient(135deg,#0e0f2c_0%,#171735_52%,#202058_100%)] border-t-2 border-t-brand border-b border-b-[#d9dafb]/15"
