...
const deCommon = {
  ...
  footer: { address: "Torre SOMA Chapultepec, Campos Elíseos 204, Polanco, 11560, CDMX", privacyNotice: "Datenschutzhinweis", copyright: "© 2025 Santos & Saucedo Abogados Alle Rechte vorbehalten.", termsOfUse: "Nutzungsbedingungen", quickLinks: "Schnellzugriff", followUs: "Folgen Sie uns", contactUs: "Kontaktieren Sie uns" },
...
const zhCommon = {
  ...
  footer: { address: "Torre SOMA Chapultepec, Campos Elíseos 204, Polanco, 11560, CDMX", privacyNotice: "隐私声明", copyright: "© 2025 Santos & Saucedo Abogados 版权所有。", termsOfUse: "使用条款", quickLinks: "快速链接", followUs: "关注我们", contactUs: "联系我们" },
...
const koCommon = {
  ...
  footer: { address: "Torre SOMA Chapultepec, Campos Elíseos 204, Polanco, 11560, CDMX", privacyNotice: "개인정보 처리방침", copyright: "© 2025 Santos & Saucedo Abogados 모든 권리 보유.", termsOfUse: "이용 약관", quickLinks: "빠른 링크", followUs: "팔로우", contactUs: "문의하기" },
...
const jaCommon = {
  ...
  footer: { address: "Torre SOMA Chapultepec, Campos Elíseos 204, Polanco, 11560, CDMX", privacyNotice: "プライバシーポリシー", copyright: "© 2025 Santos & Saucedo Abogados 無断複写・転載を禁じます。", termsOfUse: "利用規約", quickLinks: "クイックリンク", followUs: "フォロー", contactUs: "お問い合わせ" },
...
const arCommon = {
  ...
  footer: { address: "Torre SOMA Chapultepec, Campos Elíseos 204, Polanco, 11560, CDMX", privacyNotice: "إشعار الخصوصية", copyright: "© 2025 Santos & Saucedo Abogados جميع الحقوق محفوظة.", termsOfUse: "شروط الاستخدام", quickLinks: "روابط سريعة", followUs: "تابعنا", contactUs: "اتصل بنا" },
...
const ruCommon = {
  ...
  footer: { address: "Torre SOMA Chapultepec, Campos Elíseos 204, Polanco, 11560, CDMX", privacyNotice: "Политика конфиденциальности", copyright: "© 2025 Santos & Saucedo Abogados Все права защищены.", termsOfUse: "Условия использования", quickLinks: "Быстрые ссылки", followUs: "Подписывайтесь", contactUs: "Связаться с нами" },
...
const frCommon = {
  ...
  footer: { address: "Torre SOMA Chapultepec, Campos Elíseos 204, Polanco, 11560, CDMX", privacyNotice: "Politique de confidentialité", copyright: "© 2025 Santos & Saucedo Abogados Tous droits réservés.", termsOfUse: "Conditions d'utilisation", quickLinks: "Liens rapides", followUs: "Suivez-nous", contactUs: "Contactez-nous" },
...
const itCommon = {
  ...
  footer: { address: "Torre SOMA Chapultepec, Campos Elíseos 204, Polanco, 11560, CDMX", privacyNotice: "Informativa sulla Privacy", copyright: "© 2025 Santos & Saucedo Abogados Tutti i diritti riservati.", termsOfUse: "Termini di Utilizzo", quickLinks: "Link Rapidi", followUs: "Seguici", contactUs: "Contattaci" },
